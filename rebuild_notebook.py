...
cells.append({
    ...
    "source": [
        ...
        "        subprocess.run(\n",
        "            [sys.executable, \"-m\", \"pip\", \"install\", \"-q\", whl_files[0]],\n",
        "            check=True\n",
        "        )\n",
        "        return True\n",
        "\n",
...
cells.append({
    ...
    "source": [
        ...
        "\n",
        "if IS_KAGGLE:\n",
        "    # Fix OOM during MXFP4 swizzle: allow PyTorch to defragment\n",
        "    os.environ['PYTORCH_ALLOC_CONF'] = 'expandable_segments:True'\n",
        "    llm = LLM(\n",
        "        model=MODEL_PATH,\n",
        "        quantization=\"mxfp4\",\n",
        "        tensor_parallel_size=1,\n",
        "        max_model_len=16384,          # reduced from 32768 to save VRAM\n",
        "        gpu_memory_utilization=0.95,   # push to 95% on H100\n",
        "        cpu_offload_gb=10,             # offload 10GB to CPU RAM for swizzle headroom\n",
